...
if (isset($_POST['create'])) {
    ...
    if ($count['count'] > 0) {
        ...
        for ($i = 1; $i <= $studentPerGroup; $i++) {
            ...
            $queryString .= "INSERT INTO student_group VALUES (null,'$groupName', $courseId, $groups_limit, $status, $loggedIn, '$currentTime');";
        }
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <a href="instructor-add-student-groups.php?courseId=<?= $courseId; ?>&deleteQuery=yes" class="btn btn-danger pull-right" onclick="return confirm('Are you sure you want to delete all groups ?')">Delete All Group</a>
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tbody>
                                <?php
                                $result = $db->getAllRecords("SELECT * FROM student_group ORDER BY created_dt ASC");
                                if (count($result) > 0) :
